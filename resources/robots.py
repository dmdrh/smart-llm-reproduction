...
robot21 = {'name': 'robot21',  'skills': ['GoToObject', 'OpenObject', 'CloseObject', 'BreakObject', 'SliceObject', 'SwitchOn', 'SwitchOff', 
                                          'DropHandObject', 'PushObject', 'PullObject'], 'mass_capacity' : 100}
...
# Specialists
# Only OC
robot23 = {'name': 'robot23',  'skills': ['GoToObject', 'OpenObject', 'CloseObject'], 'mass_capacity' : 100}

# Only OF
robot24 = {'name': 'robot24',  'skills': ['GoToObject','SwitchOn', 'SwitchOff'], 'mass_capacity' : 100}

# Only PP
robot25 = {'name': 'robot25',  'skills': ['GoToObject','PickupObject', 'PutObject'], 'mass_capacity' : 100}

# Only S
robot26 = {'name': 'robot26',  'skills': ['GoToObject','SliceObject', 'PickupObject'], 'mass_capacity' : 100}

# Only T
robot27 = {'name': 'robot27',  'skills': ['GoToObject','BreakObject','ThrowObject'], 'mass_capacity' : 100}
